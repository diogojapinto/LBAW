    ...
    BEGIN
        IF (SELECT idProduct 
            ...
            WHERE dealState = 'Pending'
                AND idSeller = NEW.idSeller) = NEw.idProduct
        THEN
            RAISE EXCEPTION '';
        END IF;
    ...
    CREATE TRIGGER update_selling_product_trigger
        ...
        -- ################## BuyerInfo #####################
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (45,90,1);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (36,77,2);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (13,26,3);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (26,65,4);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (19,52,5);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (62,21,6);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (92,72,7);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (67,5,8);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (82,95,9);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (71,70,10);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (95,81,11);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (15,69,12);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (20,52,13);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (31,16,14);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (42,60,15);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (45,61,16);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (7,31,17);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (69,43,18);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (80,63,19);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (65,62,20);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (67,42,21);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (21,95,22);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (83,31,23);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (1,29,24);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (47,100,25);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (26,54,26);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (22,91,27);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (83,74,28);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (67,22,29);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (18,6,30);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (86,16,31);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (17,25,32);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (24,100,33);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (43,29,34);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (85,86,35);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (66,13,36);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (100,2,37);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (93,49,38);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (4,56,39);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (84,21,40);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (78,92,41);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (44,55,42);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (96,32,43);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (5,52,44);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (72,42,45);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (38,50,46);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (18,67,47);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (18,76,48);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (67,21,49);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (39,2,50);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (43,88,51);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (53,14,52);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (34,89,53);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (55,26,54);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (87,34,55);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (22,14,56);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (11,22,57);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (56,21,58);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (67,25,59);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (83,82,60);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (75,14,61);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (97,25,62);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (1,3,63);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (18,31,64);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (56,13,65);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (64,52,66);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (14,77,67);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (95,45,68);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (92,2,69);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (72,80,70);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (11,71,71);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (47,96,72);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (12,81,73);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (78,11,74);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (40,63,75);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (76,67,76);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (93,53,77);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (95,49,78);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (46,80,79);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (30,81,80);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (56,31,81);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (51,27,82);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (87,56,83);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (60,25,84);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (74,17,85);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (61,52,86);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (45,97,87);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (97,56,88);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (14,21,89);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (16,70,90);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (34,52,91);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (1,15,92);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (72,13,93);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (95,81,94);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (68,13,95);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (47,25,96);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (46,29,97);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (15,35,98);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (25,85,99);
        INSERT INTO BuyerInfo (idShippingAddress,idBillingAddress,idCreditCard) VALUES (78,26,100);
        ...
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Successful',28,80,51,'14-09-2014','21-01-2017','Shipping',51,1,'eleifend non, dapibus rutrum, justo. Praesent luctus. Curabitur egestas');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Successful',27,95,52,'30-03-2015','16-04-2016','Shipping',52,2,'congue a, aliquet vel, vulputate eu, odio. Phasellus at');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Successful',19,52,53,'31-05-2014','04-01-2016','Shipping',53,0,'risus. Morbi metus. Vivamus euismod urna. Nullam lobortis quam');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Successful',20,88,54,'05-04-2013','25-04-2015','Shipping',54,5,'Donec est. Nunc ullamcorper, velit in');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Successful',9,94,55,'14-11-2013','17-04-2015','Shipping',55,0,'Suspendisse commodo tincidunt nibh. Phasellus nulla.');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Successful',3,59,56,'10-11-2013','12-08-2016','Shipping',56,2,'dui quis accumsan convallis, ante lectus convallis');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Successful',26,56,57,'23-09-2013','02-04-2017','Shipping',57,1,'Aliquam nec');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Successful',20,62,58,'29-12-2013','29-04-2016','Shipping',58,1,'vitae sodales nisi magna');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Successful',7,100,59,'12-09-2014','27-02-2016','Shipping',59,4,'Cras sed leo.');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Successful',35,89,60,'28-02-2015','22-01-2016','Shipping',60,3,'odio semper cursus. Integer mollis. Integer tincidunt aliquam arcu. Aliquam');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Successful',13,55,61,'28-05-2013','23-01-2017','Shipping',61,4,'vestibulum.');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Successful',50,55,62,'15-05-2013','28-11-2016','Shipping',62,3,'sagittis lobortis mauris. Suspendisse aliquet molestie');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Successful',40,53,63,'20-07-2014','16-07-2016','Shipping',63,1,'nunc est, mollis non, cursus non, egestas a, dui. Cras');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Successful',49,55,64,'27-08-2014','27-09-2016','Shipping',64,3,'diam vel arcu. Curabitur');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Successful',14,98,65,'10-07-2014','06-03-2017','Shipping',65,4,'elementum at, egestas a, scelerisque sed,');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Successful',50,82,66,'03-07-2014','07-07-2016','Shipping',66,0,'eleifend vitae, erat. Vivamus nisi. Mauris nulla. Integer urna.');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Successful',20,59,67,'08-05-2014','05-02-2017','Shipping',67,3,'sed, facilisis vitae, orci.');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Successful',35,66,68,'12-07-2013','27-10-2016','Shipping',68,1,'cursus et, magna. Praesent interdum ligula eu');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Successful',6,100,69,'15-08-2014','09-01-2017','Shipping',69,1,'vulputate, posuere vulputate, lacus. Cras interdum. Nunc sollicitudin commodo ipsum.');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Successful',41,72,70,'23-08-2014','30-11-2016','Shipping',70,4,'mauris a nunc. In at pede. Cras vulputate velit eu');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Successful',5,73,71,'07-11-2014','08-06-2016','Shipping',71,5,'non, luctus sit');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Successful',10,87,72,'30-08-2014','09-09-2015','Shipping',72,5,'In at pede. Cras vulputate velit');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Successful',19,65,73,'24-09-2014','05-11-2016','Shipping',73,4,'adipiscing ligula. Aenean');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Successful',27,85,74,'31-10-2014','16-12-2015','Shipping',74,0,'Nullam lobortis quam a felis ullamcorper');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Successful',4,63,75,'23-07-2014','05-02-2017','Shipping',75,0,'Nunc');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Delivered',42,58,76,'17-09-2013','06-07-2015','Shipping',76,0,'mi, ac mattis');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Delivered',37,70,77,'21-02-2015','20-07-2015','Shipping',77,3,'a nunc. In at pede. Cras vulputate velit eu');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Delivered',45,93,78,'16-02-2014','06-04-2015','Shipping',78,0,'In');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Delivered',13,63,79,'02-04-2014','03-01-2017','Shipping',79,3,'in, dolor.');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Delivered',36,60,80,'20-12-2013','17-12-2016','Shipping',80,5,'condimentum eget, volutpat ornare, facilisis eget,');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Delivered',26,72,81,'19-01-2015','20-10-2015','Shipping',81,0,'Quisque fringilla euismod enim. Etiam gravida molestie arcu.');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Delivered',25,60,82,'13-09-2013','31-10-2016','Shipping',82,3,'lectus pede, ultrices a, auctor non, feugiat nec, diam. Duis');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Delivered',12,100,83,'03-06-2014','15-10-2016','Shipping',83,1,'pharetra. Quisque ac libero');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Delivered',13,71,84,'10-01-2014','29-05-2015','Shipping',84,2,'Nunc mauris elit, dictum eu, eleifend nec, malesuada');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Delivered',26,58,85,'16-01-2015','30-07-2016','Shipping',85,0,'molestie');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Delivered',16,75,86,'20-06-2013','29-04-2015','Shipping',86,2,'vehicula risus. Nulla');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Delivered',13,93,87,'06-04-2013','17-09-2015','Shipping',87,4,'malesuada augue ut lacus. Nulla tincidunt, neque vitae');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Delivered',48,76,88,'09-09-2013','02-07-2015','Shipping',88,2,'dolor dapibus gravida. Aliquam tincidunt, nunc ac');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Delivered',12,100,89,'07-03-2014','30-04-2015','Shipping',89,2,'augue. Sed molestie.');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Delivered',17,80,90,'02-06-2013','21-06-2015','Shipping',90,3,'ut cursus luctus, ipsum leo elementum sem,');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Delivered',46,79,91,'18-05-2013','15-09-2016','Shipping',91,4,'lacus. Aliquam');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Delivered',37,71,92,'29-07-2013','12-03-2016','Shipping',92,4,'ultrices posuere cubilia Curae;');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Delivered',36,59,93,'10-03-2015','13-07-2016','Shipping',93,1,'nibh. Donec est');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Delivered',50,88,94,'10-09-2013','25-08-2016','Shipping',94,2,'ac orci. Ut semper pretium neque. Morbi');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Delivered',43,66,95,'05-04-2014','08-07-2016','Shipping',95,0,'Vivamus non lorem vitae odio sagittis semper. Nam');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Delivered',35,70,96,'09-02-2015','18-04-2016','Shipping',96,3,'odio sagittis semper. Nam tempor diam');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Delivered',1,66,97,'03-03-2014','07-02-2016','Shipping',97,1,'Maecenas ornare egestas ligula. Nullam feugiat placerat velit. Quisque varius.');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Delivered',39,68,98,'25-11-2014','02-07-2016','Shipping',98,5,'euismod in, dolor. Fusce feugiat. Lorem ipsum dolor');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Delivered',20,90,99,'18-11-2013','31-05-2016','Shipping',99,1,'pede.');
        INSERT INTO Deal (dealState,idBuyer,idSeller,idProduct,beginningDate,endDate,deliveryMethod,idBuyerInfo,sellerRating,buyerComment) VALUES ('Delivered',11,83,100,'30-03-2014','13-09-2015','Shipping',100,2,'Proin mi. Aliquam gravida mauris ut mi. Duis risus');
        ...
        INSERT INTO Interaction (idDeal,amount,date,interactionType) VALUES (100,630.86,'2014-12-19T00:38:25-08:00','Proposal');