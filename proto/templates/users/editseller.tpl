    ...
    <div class = "row">
        ...
        <form class="form-horizontal" role="form" method="post" action="{$BASE_URL}actions/users/editseller.php">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="inputAddress3" placeholder="Morada" value="{$FORM_VALUES.address}" name="address" >
                </div>
            </div>
            <div class="form-group">
                <label for="inputCity3" class="col-sm-2 control-label">Cidade</label>
                <div class="col-sm-2">
                    <input type="text" class="form-control" id="inputCity3" placeholder="Cidade" value="{$FORM_VALUES.city}" name="city" >
                </div>
            </div>
            <div class="form-group">
                <label for="inputCity4" class="col-sm-2 control-label">Código Postal</label>
                <div class="col-sm-2">
                    <input type="text" class="form-control" id="inputCity4" placeholder="4400-404" value="{$FORM_VALUES.postalcode}" name="postalcode" >
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="text" class="form-control" id="inputCellphone3" placeholder="+351 22578467" value="{$FORM_VALUES.cellphone}" name="cellphone">
                </div>
            </div>
            <div class="form-group">
                <label for="inputDescription3" class="col-sm-2 control-label">Descrição</label>
                <div class="col-sm-5">
                    <textarea class="form-control" id="inputDescription3" placeholder="Relizam-se duplos negócios!" value="{$FORM_VALUES.description}" name="description"></textarea>
                </div>
            </div>
            <div class="form-group">
            </div>
